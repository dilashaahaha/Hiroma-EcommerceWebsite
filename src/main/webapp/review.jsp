...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="${pageContext.request.contextPath}/products?category=all">COLLECTIONS</a></li>
    ...
    <div class="review-hero">
        <a href="${pageContext.request.contextPath}/productdetail?id=${product.productId}" class="back-link">
